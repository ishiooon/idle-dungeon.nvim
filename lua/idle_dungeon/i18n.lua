...
local translations = {
  ...
  prompt_character = { en = "Select a character", jp = "キャラクターを選択してください" },
  ...
  -- 階層表示のラベルを追加する。
  label_floor = { en = "Floor:", jp = "階層:" },
  label_floor_step = { en = "Floor Progress:", jp = "階層内の進行:" },
  label_level = { en = "Level:", jp = "レベル:" },
  label_hp = { en = "HP:", jp = "体力:" },
  label_gold = { en = "Gold:", jp = "所持金:" },
  label_mode = { en = "Mode:", jp = "状態:" },
  label_progress = { en = "Progress:", jp = "進行度:" },
