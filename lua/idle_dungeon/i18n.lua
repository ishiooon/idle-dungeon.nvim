...
local translations = {
  ...
  credits_line_created = { en = "Created by ishiooon", jp = "作成者: ishiooon" },
  ...
  credits_line_message_01 = { en = "Thank you for playing Idle Dungeon.", jp = "Idle Dungeonを遊んでくれて本当にありがとう。" },
  credits_line_message_02 = { en = "This project was built with love for Neovim users.", jp = "このプロジェクトはNeovimユーザーへの愛を込めて作りました。" },
  credits_line_message_03 = { en = "If even one moment felt fun, we are happy.", jp = "一瞬でも楽しいと感じてもらえたら、とても嬉しいです。" },
  credits_line_message_04 = { en = "If something felt rough, we can still improve it.", jp = "気になる点があれば、まだまだ改善できます。" },
  credits_line_message_05 = { en = "Bug reports help this dungeon evolve.", jp = "不具合の報告は、このダンジョンを成長させる力になります。" },
  credits_line_message_06 = { en = "Your ideas can shape future updates.", jp = "あなたのアイデアが、これからの更新内容を作ります。" },
  credits_line_message_07 = { en = "Please tell us what feature you want next.", jp = "次に欲しい機能があれば、ぜひ教えてください。" },
  credits_line_message_08 = { en = "Please tell us what felt confusing or too hard.", jp = "分かりづらい点や難しすぎた点も、ぜひ教えてください。" },
  credits_line_message_09 = { en = "Even short feedback is always welcome.", jp = "短い感想でも大歓迎です。" },
  credits_line_message_10 = { en = "Share improvements anytime. Thank you again.", jp = "改善案はいつでも歓迎です。改めて、ありがとう。" },
