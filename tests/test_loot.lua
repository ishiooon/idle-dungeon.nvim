...
assert_equal(default_rates.common, 2, "通常ドロップ率の既定値がより渋めである")
assert_equal(default_rates.rare, 1, "レアドロップ率の既定値が低めである")
assert_equal(default_rates.pet, 1, "ペットドロップ率の既定値が通常戦でも低確率で発生する")
