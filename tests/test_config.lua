...
assert_true(built.ui.menu.width_ratio == 0.56, "メニューの既定幅比率が設定される")
assert_true(built.ui.menu.height_ratio == 0.54, "メニューの既定高さ比率が設定される")
assert_true(built.ui.menu.min_width == 56, "メニューの既定最小幅が設定される")
assert_true(built.ui.menu.min_height == 16, "メニューの既定最小高さが設定される")
assert_true(built.ui.menu.max_width == 76, "メニューの既定最大幅が設定される")
assert_true(built.ui.menu.max_height == 24, "メニューの既定最大高さが設定される")
...
assert_true(built.ui.menu.tabs.active_prefix == "▌ ", "タブの既定アクティブ接頭辞は視認しやすい記号である")
assert_true(built.ui.menu.tabs.active_suffix == "", "タブの既定アクティブ接尾辞は簡潔な設定である")
assert_true(built.ui.menu.tabs.show_index == false, "タブの既定表示は番号を省略する")
assert_true(built.ui.menu.item_prefix == "≫ ", "項目選択の記号は≫を使う")
