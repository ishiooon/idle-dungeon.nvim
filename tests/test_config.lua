...
assert_true(built.ui.menu.width_ratio == 0.84, "メニューの既定幅比率が設定される")
assert_true(built.ui.menu.height_ratio == 0.84, "メニューの既定高さ比率が設定される")
assert_true(built.ui.menu.min_width == 90, "メニューの既定最小幅が設定される")
assert_true(built.ui.menu.min_height == 28, "メニューの既定最小高さが設定される")
assert_true(built.ui.menu.max_width == 140, "メニューの既定最大幅が設定される")
assert_true(built.ui.menu.max_height == 40, "メニューの既定最大高さが設定される")
assert_true(built.ui.menu.padding == 3, "メニューの既定余白が拡大されている")
